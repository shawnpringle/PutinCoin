...
unsigned int nStakeMinAge = 7 * 24 * nOneHour; // days as zero time weight
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("PutinCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in PutinCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // PutinCoin: check proof-of-stake block signature
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "PUTINCOIN GENESIS";
        CTransaction txNew;
        txNew.nTime = 1490202719;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1490202719;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1818655; // !fTestNet ? 1575379 : 46534;
		
        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0xd89ce2e259761bfe18d6156598413b9a5cff350dcfb6c4ce30b7286fa94369ac"));
...
unsigned char pchMessageStart[4] = { 0xb7, 0xf0, 0xe2, 0xe5 };
