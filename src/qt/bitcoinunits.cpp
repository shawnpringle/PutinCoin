...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("PutinCoins"));
    case mBTC: return QString(QObject::tr("Milli-PutinCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-PutinCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
